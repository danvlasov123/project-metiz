function ModalsApllication2() {
  const closeModal = () => {
    document.body.classList.remove("modal-open-application2");
  };

  return (
    <div className="modal-wrapper modal-appllication2">
...
export default ModalsApllication2;
