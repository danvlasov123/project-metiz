function ModalDelete() {
  ...
  return (
    <div className="modal-wrapper modal-delete">
      ...
      <div className="modal-wrapper__title">Удалить товар из корзины?</div>
      <div className="modal-wrapper__wrapper">
        <form action="#" className="modal-wrapper__form">
          <div className="modal-wrapper__form-buttons">
            <button className="btn modal-wrapper__form-delete modal-wrapper__form-order">
              Удалить
            </button>

            <button className="btn modal-wrapper__form-close modal-wrapper__form-back">
              Отмена
            </button>
          </div>
        </form>
